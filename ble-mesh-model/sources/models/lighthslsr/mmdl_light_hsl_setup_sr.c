 ...
 */
/*************************************************************************************************/
static bool_t mmdlLightHslSetupSrProcessRangeSet(const meshModelMsgRecvEvt_t *pMsg,
...
void mmdlLightHslSetupSrHandleRangeSet(const meshModelMsgRecvEvt_t *pMsg)
{
  ...
  /* Change state */
  if (mmdlLightHslSetupSrProcessRangeSet(pMsg, &opStatus) && (opStatus!= MMDL_RANGE_PROHIBITED))
  {
...
void mmdlLightHslSetupSrHandleRangeSetNoAck(const meshModelMsgRecvEvt_t *pMsg)
{
  ...
  (void)mmdlLightHslSetupSrProcessRangeSet(pMsg, &opStatus);
}
