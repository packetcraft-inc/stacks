...
static void genOnPowerUpNvmSave(meshElementId_t lightElementId)
{
  ...
  WsfNvmWriteData(MMDL_NVM_GEN_ONPOWERUP_STATE_DATASET_ID, (uint8_t *)lightElem01GenPowOnOffStates,
...
{
  WsfNvmWriteData(MMDL_NVM_GEN_ONOFF_STATE_DATASET_ID, (uint8_t *)lightElem01GenOnOffStates,
...
{
  WsfNvmWriteData(MMDL_NVM_LIGHT_LIGHTNESS_STATE_DATASET_ID, (uint8_t *)lightElem1LightLightnessStates,
...
static void lightHslNvmSave(meshElementId_t lightElementId)
{
  ...
  WsfNvmWriteData(MMDL_NVM_LIGHT_HSL_STATE_DATASET_ID, (uint8_t *)&lightElem1LightHslSrState,
...
void LightConfig(void)
{
  ...
  retVal = WsfNvmReadData(MMDL_NVM_GEN_ONPOWERUP_STATE_DATASET_ID, (uint8_t *)lightElem01GenPowOnOffStates,
                             sizeof(lightElem01GenPowOnOffStates), NULL);

  memset(lightElem01GenOnOffStates, 0, sizeof(lightElem01GenOnOffStates));

  retVal = WsfNvmReadData(MMDL_NVM_GEN_ONOFF_STATE_DATASET_ID, (uint8_t *)lightElem01GenOnOffStates,
                             sizeof(lightElem01GenOnOffStates), NULL);

  retVal = WsfNvmReadData(MMDL_NVM_LIGHT_LIGHTNESS_STATE_DATASET_ID, (uint8_t *)lightElem1LightLightnessStates,
                             sizeof(lightElem1LightLightnessStates), NULL);

  retVal = WsfNvmReadData(MMDL_NVM_LIGHT_HSL_STATE_DATASET_ID, (uint8_t *)&lightElem1LightHslSrState,
                             sizeof(lightElem1LightHslSrState), NULL);
