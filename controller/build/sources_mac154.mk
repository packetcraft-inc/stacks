...
INC_DIRS += \
	...
	$(ROOT_DIR)/controller/sources/mac154/include
...
C_FILES += \
	...
	$(sort $(wildcard $(ROOT_DIR)/controller/sources/mac154/bb/*.c)) \
	$(sort $(wildcard $(ROOT_DIR)/controller/sources/mac154/chci/*.c)) \
	$(sort $(wildcard $(ROOT_DIR)/controller/sources/mac154/mac/*.c))
