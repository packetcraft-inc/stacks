...
INC_DIRS += \
	...
	$(ROOT_DIR)/ble-mesh-model/sources/apps/light

C_FILES += \
	$(sort $(wildcard $(ROOT_DIR)/ble-mesh-model/sources/apps/app/*.c)) \
	$(sort $(wildcard $(ROOT_DIR)/ble-mesh-model/sources/bindings/*.c)) \
	$(sort $(wildcard $(ROOT_DIR)/ble-mesh-model/sources/apps/light/*.c)) \
	$(ROOT_DIR)/projects/ble-mesh-apps/light/main.c \
	$(ROOT_DIR)/projects/ble-mesh-apps/light/stack_light.c
#--------------------------------------------------------------------------------------------------
