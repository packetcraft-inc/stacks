...
INC_DIRS += \
	...
	$(ROOT_DIR)/ble-mesh-model/sources/apps/switch

C_FILES += \
	$(sort $(wildcard $(ROOT_DIR)/ble-mesh-model/sources/apps/app/*.c)) \
	$(sort $(wildcard $(ROOT_DIR)/ble-mesh-model/sources/apps/switch/*.c)) \
	$(ROOT_DIR)/projects/ble-mesh-apps/switch/main.c \
	$(ROOT_DIR)/projects/ble-mesh-apps/switch/stack_switch.c
#--------------------------------------------------------------------------------------------------
