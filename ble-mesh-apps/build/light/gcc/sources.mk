...
INC_DIRS += \
    ...
    $(ROOT_DIR)/ble-mesh-apps/sources/light

C_FILES += \
    $(sort $(wildcard $(ROOT_DIR)/ble-mesh-apps/sources/common/*.c)) \
    $(sort $(wildcard $(ROOT_DIR)/ble-mesh-apps/sources/light/*.c)) \
    $(ROOT_DIR)/ble-mesh-apps/build/light/main.c \
    $(ROOT_DIR)/ble-mesh-apps/build/light/stack_light.c
