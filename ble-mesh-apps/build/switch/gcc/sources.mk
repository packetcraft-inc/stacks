...
INC_DIRS += \
    ...
    $(ROOT_DIR)/ble-mesh-apps/sources/switch

C_FILES += \
	$(sort $(wildcard $(ROOT_DIR)/ble-mesh-apps/sources/common/*.c)) \
	$(sort $(wildcard $(ROOT_DIR)/ble-mesh-apps/sources/switch/*.c)) \
	$(ROOT_DIR)/ble-mesh-apps/build/switch/main.c \
	$(ROOT_DIR)/ble-mesh-apps/build/switch/stack_switch.c
