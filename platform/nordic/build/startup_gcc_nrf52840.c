...
void WEAK nrfx_twim_0_irq_handler(void);
void WEAK nrfx_twim_1_irq_handler(void);
...
void WEAK nrfx_qspi_irq_handler(void);
...
#pragma weak nrfx_twim_0_irq_handler                        = SystemDefaultHandler
#pragma weak nrfx_twim_1_irq_handler                        = SystemDefaultHandler
...
#pragma weak nrfx_qspi_irq_handler                          = SystemDefaultHandler
...
void (* const systemVectors[256])(void) =
{
  ...
  nrfx_twim_0_irq_handler,                      /* 19: SPIM0_SPIS0_TWIM0_TWIS0_SPI0_TWI0 */
  nrfx_twim_1_irq_handler,                      /* 20: SPIM1_SPIS1_TWIM1_TWIS1_SPI1_TWI1 */
...
{
#if defined (__GNUC__)
  /* Reset appropriate CPU registers */
