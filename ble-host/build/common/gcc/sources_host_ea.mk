...
C_FILES += \
	...
	$(ROOT_DIR)/ble-host/sources/stack/att/att_eatt.c \
	...
	$(ROOT_DIR)/ble-host/sources/stack/att/attc_eatt.c \
	...
	$(ROOT_DIR)/ble-host/sources/stack/att/atts_eatt.c \
	$(ROOT_DIR)/ble-host/sources/stack/cfg/cfg_stack.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_adv.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_adv_ae.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_adv_leg.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_bis_master.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_bis_slave.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_cis.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_cis_master.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_cis_slave.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_cis_sm.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_conn.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_conn_cte.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_conn_master.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_conn_master_ae.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_conn_master_leg.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_conn_slave.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_conn_slave_ae.c \
	...
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_iso.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_main.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_past.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_phy.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_priv.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_scan.c \
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_scan_ae.c \
	...
	$(ROOT_DIR)/ble-host/sources/stack/dm/dm_sync_ae.c \
